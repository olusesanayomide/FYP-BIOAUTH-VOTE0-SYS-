      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3.5">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            ...
            className="text-sm text-foreground border border-border/80 bg-card/80 dark:bg-transparent px-5 py-2 rounded-lg transition-all duration-300 hover:border-primary/40 disabled:opacity-70 disabled:cursor-not-allowed inline-flex items-center gap-2"
          >
